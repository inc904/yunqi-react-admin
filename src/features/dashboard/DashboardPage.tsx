...
export function DashboardPage() {
  ...
  return (
    <>
      <PageTitle title="早上好，运营同学" description="今天是业务冲刺的好日子，先看看关键数据。" />
        ...
        <div className="pending-grid">
          {overview.data &&
            [
              ...
              <button className="pending-card" onClick={() => navigate(item.to)} key={item.label}>
              ...
              <div className="chart">
                <ResponsiveContainer width="100%" height={300}>
                  <AreaChart data={trend.data}>
                    ...
                    <Tooltip formatter={(value: number) => money(value)} labelFormatter={(value) => `日期：${value}`} />
                    <Area type="monotone" dataKey="gmv" stroke="#2563eb" strokeWidth={2.5} fill="url(#gmv)" />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
            )}
